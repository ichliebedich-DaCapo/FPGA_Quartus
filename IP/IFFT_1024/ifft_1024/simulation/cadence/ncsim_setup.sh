...
TOP_LEVEL_NAME="ifft_1024"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="E:/tools/develop/embedded/intelfpga/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twqfp1.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twqfp2.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twqfp3.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twqfp4.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twifp1.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twrfp1.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twifp2.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twifp3.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twrfp2.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twifp4.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twrfp3.hex ./
  cp -f $QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0_twrfp4.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ifft_1024_fft_ii_0.sv"  -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/ifft_1024.v"                                                                         
fi
